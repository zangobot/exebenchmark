...
metadata = pd.read_csv("/Users/bridge/PhD/Code/exebenchmark/configurations/SPEAKEASY/all_metadata.csv")
...
metadata_label_0['year_month'] = pd.to_datetime(metadata_label_0['year_month'], errors='coerce')
...
metadata_label_1['year_month'] = pd.to_datetime(metadata_label_1['year_month'], errors='coerce')
