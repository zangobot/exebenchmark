...
#SBATCH -o drago_jobs/shift/slurm.%A_%a.out  # STDOUT
#SBATCH -e drago_jobs/shift/slurm.%A_%a.err  # STDERR
...
CONFS=($(find configurations/ADVERSARIAL/ -mindepth 1 -maxdepth 2 -type f -iname "*shift*"))
